...
class BaseTrainer():
    def __init__(self, opt):
        ...
        self.is_official = 'OFFICIAL' in self.opt   # 返回true或false
        # Make sure raw text feature files are ready
        self.use_spacy = 'SPACY_FEATURE' in self.opt  # 返回true或false
    ...
    def getSaveFolder(self):
        runid = 1
        while True:
            saveFolder = os.path.join(self.opt['datadir'], 'conf~', 'result_' + str(runid))
